...
import 'package:zameny_flutter/domain/Providers/timer_provider.dart';
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    'Осталось: $timeLeft',
                    style: context.styles.ubuntuBold18.copyWith(color: Theme.of(context).primaryColorLight.withOpacity(0.7)),
                  ),
                ],
              ),
            ],
